...
export class Backend implements backendInterface {
    ...
    async fetchGoogleSheet(): Promise<CsvContent> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchGoogleSheet();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getGoogleSheetsURL(): Promise<SheetUrl> {
        if (this.processError) {
            try {
                const result = await this.actor.getGoogleSheetsURL();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isValid(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isValid();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setGoogleSheetsURL(arg0: SheetUrl): Promise<void> {
        if (this.processError) {
            try {
